                    ...
                    <div class="documents">
                        ...
                        <div class="report-generation">
                            ...
                            <div class="form-section">
                                <div class="invoice-form active" id="invoiceFields" style="display: block;">
                                    ...
                                    <div class="two-column-layout">
                                        <div class="filter-section">
                                            ...
                                            <div class="input-with-lock">
                                                <input type="text" id="contractorName" name="contractorName" value="{{ $businessInfo['contractorName'] ?? '' }}" readonly required  style="display: none;">
                                    ...
                                    <div class="two-column-layout">
                                        ...
                                        <div class="filter-section">
                                            ...
                                            <div class="input-with-lock">
                                                <input type="text" id="invoiceNumber" name="invoiceNumber" readonly value="{{ $invoiceInfo['invoiceNumber'] }}" title="Not-editable">
                                                <span class="lock-icon">🔒</span>
                                            </div>
                                            <label for="invoiceDate">Date:</label>
                                            <div class="input-with-lock">
                                                <input type="date" id="invoiceDate" name="invoiceDate" readonly value="{{ isset($invoiceInfo['invoiceDate']) ? $invoiceInfo['invoiceDate'] : '' }}" required title="Not-editable">
                                                <span class="lock-icon">🔒</span>
                                            </div>
                                            <label for="paymentTerm">Payment Term (Days):</label>
                                            <input type="number" id="paymentTerm" name="paymentTerm" min="1" placeholder="Enter days (e.g., 30, 60)" value="{{ isset($invoiceInfo['paymentTerm']) ? $invoiceInfo['paymentTerm'] : '' }}" required>
                                            <span id="paymentTermError" class="errorMessage"></span>

                                            <label for="calculatedDueDate">Due Date:</label>
                                            <input type="text" id="calculatedDueDate" name="calculatedDueDate" readonly value="{{ isset($invoiceInfo['dueDate']) ? $invoiceInfo['dueDate'] : '' }}" id="dueDate" name="dueDate">
                                        </div>
                                    ...
                                    <div class="action-buttons">
                                        <button id="previewReport" class="button">Preview Invoice</button>
                                        <button id="saveReport" class="button">Save Invoice</button>
                                        <button id="downloadReport" class="button">Download Invoice</button>
                                        <button id="resetReport" class="button">Reset Invoice</button>
                                    </div>
...
// Function to calculate deposit amount
            ...
            function showUploadLogoPanel() {
                document.getElementById('uploadLogoPanel').style.display = 'block';
            }
...
// Handle Preview Button Click
                document.getElementById("previewReport").addEventListener("click", function (e) {
                    ...
                    if (validateForm()) {
                        ...
                        generateInvoice(projectID, reportData);
                    } else {
...
// Handle Save Button Click
                document.getElementById("saveReport").addEventListener("click", function (e) {
                    ...
                    if (validateForm()) {
                        ...
                        saveInvoice(projectID, reportData);
                    } else {
                        displayErrorMessage("Please correct the errors above before proceeding.");
                    }
                });
...
// Handle Download Button Click
            ...
            function collectReportData() {
                return {
                    reportType: "invoice", // or "quotation"
                    businessInfo: {
            ...
            function generateInvoice(projectID, reportData) {
                fetch(`/generate-invoice/${projectID}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
            ...
            function saveInvoice(projectID, reportData) {
                showLoading();

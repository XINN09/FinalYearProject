...
<html lang="en">
    <head>
        ...
        <title>Create Account with Invitation</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('OwnerInvitedRegister.submit') }}">
                    @csrf
                    ...
                    <div class="scroll-box">
                        ...
                        <h4>Email</h4>
                        <input type="email" name="email" placeholder="Enter your email address" value="{{ $email ?? old('email') }}" required readonly />
                        @error('email')
                        <div class="error-message">{{ $message }}</div>
                        @enderror
